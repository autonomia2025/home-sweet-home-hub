    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16 md:h-20">
        ...
        <div className="hidden md:flex items-center gap-8">
          {[
            ...
            <button
              ...
              className="text-[11px] tracking-[0.2em] text-white/70 hover:text-white transition-colors uppercase font-body"
              style={{ fontWeight: 300 }}
            >
              {item.label}
            </button>
        ...
        <button
          ...
          className="text-[11px] tracking-[0.2em] uppercase border border-white/40 px-5 py-2.5 text-white hover:bg-white hover:text-[#2c3e2c] transition-all duration-300 font-body"
